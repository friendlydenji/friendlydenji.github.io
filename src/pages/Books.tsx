    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="mb-12 flex flex-col md:flex-row md:items-end md:justify-between gap-8">
                <div>
                    <h1 className="text-4xl font-black tracking-tight mb-4">Tóm tắt tý sách</h1>
                    <p className="text-xl text-[var(--text-secondary)] max-w-2xl">
                        "Đọc một đống sách để bớt hống hách <br></br>
                        Học cách tìm đỉnh của sự điềm tĩnh" <br></br>
                        Chỗ mình bắt chước Goodreads để track sách, cố gắng tóm tắt mấy cuốn sách non-fiction và vẽ mấy cái hình mà mình nhớ về mấy cuốn sách fiction.
                    </p>
                </div>
