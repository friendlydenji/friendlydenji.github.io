...
import { Library, ChevronDown, Trophy, BookOpen, Book, Gamepad2, BrainCircuit, PenTool } from 'lucide-react';
...
const LibraryMenu: React.FC = () => {
    return (
        <div className="group h-full flex items-center px-4 relative cursor-pointer">
            ...
            <div className="absolute top-full left-0 w-[780px] bg-white dark:bg-gray-900 border border-t-0 border-gray-100 dark:border-gray-800 shadow-2xl opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-300 rounded-b-2xl overflow-hidden grid grid-cols-3">
                ...
                <div className="p-6 bg-gray-50/50 dark:bg-gray-800/20">
                    ...
                    <div className="space-y-4">
                        <Link to="/writing/rambling" className="flex items-center gap-3 group/item">
                            <div className="w-8 h-8 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center group-hover/item:border-blue-600 transition-colors">
                                <PenTool className="w-4 h-4 text-gray-400 group-hover/item:text-blue-600" />
                            </div>
                            <span className="text-sm font-bold text-gray-700 dark:text-gray-300">Rambling</span>
                        </Link>
                    </div>
                </div>
            </div>
